$(function(){
	...
	var featuredImage = function() {	
	  $("#featured figure hacker_news_img").each(function(){
	  	$(this).parent().css({
			...
			$.ajax({
				...
				success: function(data) {
					$this.find("[data-youtube-id]").each(function(i){
						...
						$item.find("figure").removeClass("loading").append("<hacker_news_img src='"+data.items[i].snippet.thumbnails.medium.url+"'>");
